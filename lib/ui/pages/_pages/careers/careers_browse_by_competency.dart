...
class CareerBrowseByCompetency extends StatefulWidget {
  const CareerBrowseByCompetency({Key key}) : super(key: key);

  @override
  _CareerBrowseByCompetencyState createState() =>
      _CareerBrowseByCompetencyState();
}

class _CareerBrowseByCompetencyState extends State<CareerBrowseByCompetency> {
                  ...
                  children: [
                    Container(
                      ...
                      child: Padding(
                        ...
                        child: Text('Browse careers by competency',
