...
class CompetencyFilters extends StatefulWidget {
  ...
  CompetencyFilters(
      ...
      : super(key: key);
  @override
  _CompetencyFiltersState createState() => _CompetencyFiltersState();
}

class _CompetencyFiltersState extends State<CompetencyFilters> {
  Map data;
