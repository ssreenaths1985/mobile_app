                            ...
                            child: Column(
                              ...
                              children: [
                                Row(
                                  ...
                                  children: [
                                    Text(
                                      _savedResources[index].source != null
                                    ...
                                    (_savedResources[index].bookmark != null)
                                ...
                                _savedResources[index]
                                    ...
                                    ? Container(
                                        ...
                                        child: Row(
                                          children: [
                                            _savedResources[index].files != null
                                                ...
                                                : Center(),
                                            _savedResources[index].urls != null
                                                ? _link(_savedResources[index]
                                                    .urls
                                                    .length)
                                                : Center()
                                          ],
